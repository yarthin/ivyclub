...
<head>
    <title>Photos - IVY - club & events stilvolle Atmosphäre für ausgelassene Club Nächte</title>
...
<div id="my-contact-div"><!-- Reservation Sidebar Form --></div>
    <header>
        <nav>
            ...
            <div class="page-content">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                        <div class="tiva-events-calendar compact" data-view="list" data-switch="hide"></div>
                        </div>
                    </div>
                </div>
            </div>
