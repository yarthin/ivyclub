...
(function() {
    ...
    for (var i = 0; i < nEls; i++) {
        ...
        if (el.src.match(re)) {
            ...
            var landingpageUrl = el.src.substr(el.src.indexOf('landingpage=') + 12,
                el.src.length);
            var iframe = document.createElement('iframe');
            var landingpageName = landingpageUrl.substr(landingpageUrl.indexOf("/l/") + 3, landingpageUrl.length);
            landingpageName = landingpageName.replace('?showMenu=false', '');
            landingpageName = "passcreator-" + landingpageName;

            if (document.getElementById(landingpageName) == null) {
                iframe.setAttribute("src", landingpageUrl);
                iframe.setAttribute("frameborder", "0");
                iframe.setAttribute("id", landingpageName);               
