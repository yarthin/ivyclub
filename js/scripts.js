...
function closeProjects() {
 ...
 if (isExists(('.single-page-wrapper'))) {
  $singleProjectWrapper.removeClass('page-slide');
 }
 if (isExists(('.projects'))) {
  $projects.removeClass('visible-projects');
 }
